                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (member.dateOfBirth != null)
                              Text('Birthday: ${DateFormat('dd MMMM yyyy').format(member.dateOfBirth!)}', style: const TextStyle(color: Colors.grey)),
                          ],
                        ),
                      ),
                    ],
        ...
        child: Row(
          children: [
            CircleAvatar(
              ...
              child: Icon(Icons.person, color: isToday ? MMPApp.maroon : Colors.grey),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: Column(
